(function( $ ){
  ...
  var methods = {
	...
	// Default settings 
	 var settings = $.extend( {
      fullImg : 'images/rating/full.png',
	  emptyImg : 'images/rating/empty.png',
	  zero : false,
	  zeroImg : 'images/rating/zero.png',
	  value : 1,
	  max: 5,
	  hover: true,
	  hoverImg: 'images/rating/hover.png',
	  disabled : false,
	  disabledZeroImg : 'images/rating/zero.png',
	  disabledFullImg: 'images/rating/full.png',
	  disabledEmptyImg: 'images/rating/empty.png',
    }, options);
